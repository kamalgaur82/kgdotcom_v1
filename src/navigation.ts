  ...
  links: [
    ...
    },
    {
      ...
      links: [
        ...
        {
          text: 'Category Page',
          href: getPermalink('general', 'category'),
        },
        {
          text: 'Tag Page',
...
export const footerData = {
  ...
  socialLinks: [
    { ariaLabel: 'X', icon: 'tabler:brand-x', href: 'https://www.x.com/kamalgaur' },
  ...
  footNote: `
    ...
    Made by <a class="text-blue-600 underline dark:text-muted" href="mailto:jpxavier11@gmail.com"> Jeffrey P Xavier</a> · All rights reserved.
  `,
};
